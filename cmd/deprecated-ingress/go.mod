module github.com/ministryofjustice/cloud-platform-environments/cmd/deprecated-ingress
...
require (
	...
	github.com/rs/zerolog v1.21.1-0.20210413053206-582f0cf0e39b // indirect
