 ...
 *
 */
module "viper_offender_data_omic_s3_bucket" {
...
resource "kubernetes_secret" "viper_offender_data_omic_s3_bucket" {
  ...
  data {
    access_key_id     = "${module.viper_offender_data_omic_s3_bucket.access_key_id}"
    secret_access_key = "${module.viper_offender_data_omic_s3_bucket.secret_access_key}"
    bucket_arn        = "${module.viper_offender_data_omic_s3_bucket.bucket_arn}"
    bucket_name       = "${module.viper_offender_data_omic_s3_bucket.bucket_name}"
  }
}