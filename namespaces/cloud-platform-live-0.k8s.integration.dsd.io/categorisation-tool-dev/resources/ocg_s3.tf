 ...
 *
 */
module "ocg_offender_data_omic_s3_bucket" {
...
resource "kubernetes_secret" "ocg_offender_data_omic_s3_bucket" {
  ...
  data {
    access_key_id     = "${module.ocg_offender_data_omic_s3_bucket.access_key_id}"
    secret_access_key = "${module.ocg_offender_data_omic_s3_bucket.secret_access_key}"
    bucket_arn        = "${module.ocg_offender_data_omic_s3_bucket.bucket_arn}"
    bucket_name       = "${module.ocg_offender_data_omic_s3_bucket.bucket_name}"
  }
}