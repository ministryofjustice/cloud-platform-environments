module "secrets_manager" {
  ...
  secrets = {
    "maat_api_oauth_client_id" = {
      description             = "MAAT API oauth client ID for Evidence Test",
      recovery_window_in_days = 7
      k8s_secret_name         = "maat-api-oauth-client-id"
    },
    "maat_api_oauth_client_secret" = {
      description             = "MAAT API oauth client secret for Evidence Test",
      recovery_window_in_days = 7
      k8s_secret_name         = "maat-api-oauth-client-secret"
    },
    "sentry_dsn" = {
      description             = "Sentry Data Source Name (DSN) for Crime Evidence Test",
      recovery_window_in_days = 7,
      k8s_secret_name         = "sentry-dsn"
    },
    "ingress_internal_allowlist_source_range" = {
      description             = "Internal IP allowlist for Evidence Test",
      recovery_window_in_days = 7,
