...
module "cla_backend_snapshot_restore" {
  source        = "github.com/ministryofjustice/cloud-platform-terraform-rds-instance?ref=9.2.0"
  storage_type  = "gp2"
  vpc_name      = var.vpc_name
  team_name     = var.team_name
  ...
  db_name                      = "cla_backend_snapshot_restore"
  db_instance_class            = "db.t4g.large"
  ...
  snapshot_identifier = "cla-backend-before-deletion-2026-05-14"
...
module "cla_backend_intermediary" {
  ...
  snapshot_identifier = "rds:cloud-platform-3523d8064f052e84-2026-05-26-02-53"
...
resource "kubernetes_secret" "cla_backend_snapshot_restore" {
  ...
  data = {
    endpoint         = module.cla_backend_snapshot_restore.rds_instance_endpoint
    host             = module.cla_backend_snapshot_restore.rds_instance_address
    port             = module.cla_backend_snapshot_restore.rds_instance_port
    name             = module.cla_backend_snapshot_restore.database_name
    user             = module.cla_backend_snapshot_restore.database_username
    password         = module.cla_backend_snapshot_restore.database_password
    replica_host     = module.cla_backend_snapshot_restore.rds_instance_address
    replica_endpoint = module.cla_backend_snapshot_restore.rds_instance_endpoint
    db_identifier    = module.cla_backend_snapshot_restore.db_identifier
  }
}
