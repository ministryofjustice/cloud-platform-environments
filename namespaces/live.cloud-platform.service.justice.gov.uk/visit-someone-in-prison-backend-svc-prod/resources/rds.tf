...
module "visit_scheduler_store_rds" {
  source                 = "github.com/ministryofjustice/cloud-platform-terraform-rds-instance?ref=7.2.0"
  vpc_name               = var.vpc_name
  team_name              = var.team_name
  business_unit          = var.business_unit
...
resource "kubernetes_secret" "visit_scheduler_rds" {
  ...
  data = {
    rds_instance_endpoint = module.visit_scheduler_store_rds.rds_instance_endpoint
    database_name         = module.visit_scheduler_store_rds.database_name
    database_username     = module.visit_scheduler_store_rds.database_username
    database_password     = module.visit_scheduler_store_rds.database_password
    rds_instance_address  = module.visit_scheduler_store_rds.rds_instance_address
  }
}
