module "opensearch_alert_app_log" {
  ...
  secret_name                    = "live-laa-data-claims-api-staging-33964ad8f3771f50" 
  ...
  opensearch_alert_name          = "laa-data-claims-api-staging-sql-alert"
  ...
  trigger_name                   = "laa-data-claims-api-staging-sql-trigger"
  serverity                      = "1"
