...
variable "domain" {
  ...
  type        = string
  default     = "health-and-medication-preprod.hmpps.service.justice.gov.uk"
}

variable "application" {
  description = "Name of the application you are deploying"
  type        = string
  default     = "hmpps-health-and-medication-api"
}

variable "namespace" {
  description = "Name of the namespace these resources are part of"
  type        = string
  default     = "hmpps-health-and-medication-api-preprod"
}
