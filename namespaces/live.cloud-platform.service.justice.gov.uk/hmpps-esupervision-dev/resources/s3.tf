  ...
  cors_rule =[
    {
      ...
      allowed_origins = ["https://esupervision-dev.hmpps.service.justice.gov.uk","https://manage-people-on-probation-dev.hmpps.service.justice.gov.uk","https://probation-check-in-dev.hmpps.service.justice.gov.uk","http://localhost:3000"]
      expose_headers  = ["ETag"]
