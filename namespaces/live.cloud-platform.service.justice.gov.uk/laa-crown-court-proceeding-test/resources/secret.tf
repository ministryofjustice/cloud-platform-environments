module "secrets_manager" {
  ...
  secrets = {
    "maat_api_oauth_client_id" = {
      description             = "MAAT API oauth client ID for CCP Test",
      recovery_window_in_days = 7
      k8s_secret_name         = "maat-api-oauth-client-id"
    },
    "maat_api_oauth_client_secret" = {
      description             = "MAAT API oauth client secret for CCP Test",
      recovery_window_in_days = 7
      k8s_secret_name         = "maat-api-oauth-client-secret"
    },
    "cda_oauth_client_id" = {
      description             = "CDA oauth client ID for CCP Test",
      recovery_window_in_days = 7
      k8s_secret_name         = "cda-oauth-client-id"
    },
    "cda_oauth_client_secret" = {
      description             = "CDA oauth client secret for CCP Test",
      recovery_window_in_days = 7
      k8s_secret_name         = "cda-oauth-client-secret"
    },
    "evidence_oauth_client_id" = {
      description             = "Evidence Service oauth client ID for CCP Test",
      recovery_window_in_days = 7
      k8s_secret_name         = "evidence-oauth-client-id"
    },
    "evidence_oauth_client_secret" = {
      description             = "Evidence Service oauth client secret for CCP Test",
      recovery_window_in_days = 7
      k8s_secret_name         = "evidence-oauth-client-secret"
    },
    "sentry_dsn" = {
      description             = "Sentry Data Source Name (DSN) for CCP Test",
      recovery_window_in_days = 7,
      k8s_secret_name         = "sentry-dsn"
    },
    "prosecution_concluded_db_username" = {
      description             = "Prosecution Concluded DB Username for CCP Test",
      recovery_window_in_days = 7,
      k8s_secret_name         = "sqs-prosecution-concluded-db-username"
    },
    "email_client_notify_key" = {
      description             = "Email notification client key CCP Test",
      recovery_window_in_days = 7,
