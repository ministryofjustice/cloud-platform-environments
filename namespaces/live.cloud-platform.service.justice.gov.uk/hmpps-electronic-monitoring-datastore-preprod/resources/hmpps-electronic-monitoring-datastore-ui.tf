module "hmpps_electronic_monitoring_datastore_ui" {
  source      = "github.com/ministryofjustice/cloud-platform-terraform-hmpps-template?ref=1.1.0"
  github_repo = "hmpps-electronic-monitoring-datastore-ui"
  application = "hmpps-electronic-monitoring-datastore-ui"
...
module "elasticache_redis" {
  ...
  application            = module.hmpps_electronic_monitoring_datastore_ui.application
  is_production          = var.is_production
  namespace              = var.namespace
...
resource "kubernetes_secret" "elasticache_redis" {
  metadata {
    name      = "${module.hmpps_electronic_monitoring_datastore_ui.application}-elasticache-redis"
    namespace = var.namespace
  }
