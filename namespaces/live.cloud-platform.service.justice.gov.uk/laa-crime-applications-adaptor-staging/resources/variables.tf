...
variable "namespace" {
  ...
  type        = string
  default     = "laa-crime-applications-adaptor-staging"
}
...
variable "api_gateway_name" {
  ...
  default     = "caa-api-gateway-staging"
}
...
variable "user_pool_name" {
  ...
  default     = "caa-api-staging-userpool"
}
...
variable "resource_server_identifier" {
  ...
  default     = "caa-api-staging"
}

variable "resource_server_name" {
  description = "Cognito resource server name"
  default     = "caa-api-staging-resource-server"
}
