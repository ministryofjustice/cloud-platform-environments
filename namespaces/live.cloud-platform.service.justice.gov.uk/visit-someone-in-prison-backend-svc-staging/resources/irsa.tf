...
locals {
  ...
  sqs_policies = {
    hmpps_prison_visits_event_queue = module.hmpps_prison_visits_event_queue.irsa_policy_arn
    hmpps_prison_visits_event_dlq   = module.hmpps_prison_visits_event_dead_letter_queue.irsa_policy_arn
  }
