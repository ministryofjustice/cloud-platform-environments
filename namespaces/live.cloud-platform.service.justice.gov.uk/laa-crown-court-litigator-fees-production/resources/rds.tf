module "rds-instance-migrated" {
  ...
  db_engine_version        = "19.0.0.0.ru-2026-04.rur-2026-04.r1"
...
resource "aws_security_group_rule" "mp_production_subnet_data_2a" {
  ...
  to_port           = 1521
  security_group_id = aws_security_group.rds.id
  description       = "Modernisation Platform production data subnet 2a to connect CCLF DB"
}
...
resource "aws_security_group_rule" "mp_production_subnet_data_2b" {
  ...
  to_port           = 1521
  security_group_id = aws_security_group.rds.id
  description       = "Modernisation Platform production data subnet 2b to connect CCLF DB"
}
