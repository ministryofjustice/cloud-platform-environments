    ...
    Statement = [
      {
        ...
        Resource = [
          "arn:aws:secretsmanager:eu-west-2:450842467489:secret:/postgres/database/hmpps-arns-assessment-view-db-preprod/cloud-platform-config-*"
        ]
      },
      {
        ...
        Resource = "arn:aws:kms:eu-west-2:450842467489:key/*"
      }
    ]
  })
