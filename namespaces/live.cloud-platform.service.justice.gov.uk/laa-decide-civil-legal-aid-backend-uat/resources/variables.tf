...
variable "application" {
  ...
  type        = string
  default     = "API that allows creating and editing of civil legal aid decisions"
}

variable "namespace" {
  description = "Name of the namespace these resources are part of"
  type        = string
  default     = "laa-decide-civil-legal-aid-backend-uat"
}

variable "repo_name" {
  default = "laa-decide-civil-legal-aid-backend"
}
...
variable "infrastructure_support" {
  ...
  type        = string
  default     = "decide@digital.justice.gov.uk"
}
