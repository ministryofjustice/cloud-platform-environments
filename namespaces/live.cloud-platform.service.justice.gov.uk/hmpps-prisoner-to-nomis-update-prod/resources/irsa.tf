...
locals {
  sqs_queues = {
    ...
    "Digital-Prison-Services-prod-hmpps_prisoner_to_nomis_incentive_queue"  = "hmpps-domain-events-prod"
    "Digital-Prison-Services-prod-hmpps_prisoner_to_nomis_sentencing_dlq"   = "hmpps-domain-events-prod"
    "Digital-Prison-Services-prod-hmpps_prisoner_to_nomis_sentencing_queue" = "hmpps-domain-events-prod"
