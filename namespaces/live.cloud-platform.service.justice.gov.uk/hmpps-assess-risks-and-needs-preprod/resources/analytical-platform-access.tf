data "aws_iam_policy_document" "ap_access" {
  ...
  statement {
    ...
    resources = [
      "arn:aws:s3:::moj-reg-preprod/landing/hmpps-assess-risks-and-needs-preprod/*",
      "arn:aws:s3:::moj-reg-preprod/landing/hmpps-assess-risks-and-needs-preprod/"
    ]
  }
}
...
resource "kubernetes_secret" "ap_aws_secret" {
  ...
  data = {
    destination_bucket = "s3://moj-reg-preprod/landing/hmpps-assess-risks-and-needs-preprod/"
