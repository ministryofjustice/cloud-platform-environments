...
variable "application" {
  ...
  type        = string
  default     = "HMPPS Alerts"
}

variable "namespace" {
  description = "Name of the namespace these resources are part of"
  type        = string
  default     = "hmpps-alerts-preprod"
}
...
# NB: connect-dps now look after hmpps-alerts but `team_name` cannot be updated as this will affect infrastructure - eg it is used to name queues
variable "team_name" {
