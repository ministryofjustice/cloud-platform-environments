# For Cloud Platform deployed projects based on the hmpps-stevec-sre-test-ui template:
...
module "hmpps_template_typescript" {
  ...
  github_repo = "hmpps-stevec-sre-test-ui"
  application = "hmpps-stevec-sre-test-ui"
  ...
  source_template_repo          = "hmpps-stevec-sre-test-ui"
...
# Note, redis is a requirement for hmpps-stevec-sre-test-ui application.
