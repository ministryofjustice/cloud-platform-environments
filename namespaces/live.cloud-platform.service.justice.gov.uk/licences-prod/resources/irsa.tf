...
locals {
  sqs_queues = {
    "Digital-Prison-Services-prod-hdc_domain_events_queue"       = "hmpps-domain-events-prod",
    "Digital-Prison-Services-prod-hdc_domain_events_dl"          = "hmpps-domain-events-prod"
  }
