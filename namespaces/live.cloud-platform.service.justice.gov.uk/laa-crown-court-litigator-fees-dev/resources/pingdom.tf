...
resource "pingdom_check" "laa-crown-court-litigator-fees-dev" {
  type                     = "http"
  name                     = "Crown Court Litigator Fees dev"
  host                     = "cclf-dev.apps.live.cloud-platform.service.justice.gov.uk"
  resolution               = 1
