...
resource "aws_cognito_user_pool_client" "functional_tests_client_ccp_dev" {
  name                                 = var.cognito_user_pool_functional_tests_name_dev
  user_pool_id                         = aws_cognito_user_pool.ccp_user_pool.id
  explicit_auth_flows                  = ["ALLOW_REFRESH_TOKEN_AUTH"]
  allowed_oauth_flows                  = ["client_credentials"]
  allowed_oauth_flows_user_pool_client = true
...
resource "aws_cognito_user_pool_client" "functional_tests_client_ccp_tst" {
  name                                 = var.cognito_user_pool_functional_tests_name_tst
  user_pool_id                         = aws_cognito_user_pool.ccp_user_pool.id
  explicit_auth_flows                  = ["ALLOW_REFRESH_TOKEN_AUTH"]
  allowed_oauth_flows                  = ["client_credentials"]
  allowed_oauth_flows_user_pool_client = true
...
resource "aws_cognito_user_pool_client" "functional_tests_client_ccp_uat" {
  name                                 = var.cognito_user_pool_functional_tests_name_uat
  user_pool_id                         = aws_cognito_user_pool.ccp_user_pool.id
  explicit_auth_flows                  = ["ALLOW_REFRESH_TOKEN_AUTH"]
  allowed_oauth_flows                  = ["client_credentials"]
  allowed_oauth_flows_user_pool_client = true
