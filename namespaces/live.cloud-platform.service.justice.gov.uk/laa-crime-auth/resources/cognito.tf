...
resource "aws_cognito_user_pool_client" "ccp_client" {
  name                                 = var.cognito_user_pool_ccp_client_name
...
resource "aws_cognito_resource_server" "resource" {
  ...
  scope {
    scope_name        = var.resource_server_ccp_scope_name
    scope_description = var.resource_server_ccp_scope_description
  }
  user_pool_id = aws_cognito_user_pool.pool.id
}
