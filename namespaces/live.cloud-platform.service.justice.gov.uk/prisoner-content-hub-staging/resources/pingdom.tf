...
resource "pingdom_check" "prisoner-content-hub-staging-checks" {
  ...
  encryption               = true
  port                     = 443
  tags                     = "businessunit_${var.business_unit},application_prisoner_content_hub,component_healthcheck,isproduction_${var.is_production},environment_${var.environment-name},infrastructuresupport_platforms"
