...
resource "kubernetes_secret" "hmpps-content-hub-ui-redis" {
  metadata {
  ...
  data = {
    primary_endpoint_address = module.hmpps-content-hub-ui-redis.primary_endpoint_address
    auth_token               = module.hmpps-content-hub-ui-redis.auth_token
    member_clusters          = jsonencode(module.hmpps-content-hub-ui-redis.member_clusters)
    replication_group_id     = module.hmpps-content-hub-ui-redis.replication_group_id
  }
}
