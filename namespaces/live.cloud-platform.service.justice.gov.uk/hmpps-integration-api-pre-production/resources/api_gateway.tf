...
resource "aws_api_gateway_deployment" "pre_production" {
  rest_api_id = aws_api_gateway_rest_api.api_gateway.id
...
resource "aws_api_gateway_usage_plan" "default" {
  ...
  api_stages {
    ...
    stage  = aws_api_gateway_stage.pre_production.stage_name
  }
}
...
resource "aws_api_gateway_base_path_mapping" "hostname" {
  ...
  stage_name  = aws_api_gateway_stage.pre_production.stage_name
}
...
resource "aws_api_gateway_stage" "pre_production" {
  deployment_id = aws_api_gateway_deployment.pre_production.id
  rest_api_id   = aws_api_gateway_rest_api.api_gateway.id
