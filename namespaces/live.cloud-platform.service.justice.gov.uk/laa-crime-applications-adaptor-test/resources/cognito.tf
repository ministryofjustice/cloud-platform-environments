...
resource "aws_cognito_user_pool_client" "maat_client_test" {
...
resource "kubernetes_secret" "aws_cognito_user_pool_client" {
  ...
  data = {
    maat_client_id     = aws_cognito_user_pool_client.maat_client_test.id
    maat_client_secret = aws_cognito_user_pool_client.maat_client_test.client_secret
