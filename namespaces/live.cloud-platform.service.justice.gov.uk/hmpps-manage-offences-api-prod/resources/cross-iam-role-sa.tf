module "irsa" {
  ...
  role_policy_arns = [aws_iam_policy.hmpps_manage_offences_api_prod_ap_policy.arn]
}
data "aws_iam_policy_document" "hmpps_manage_offences_api_prod_ap_policy" {
...
resource "aws_iam_policy" "hmpps_manage_offences_api_prod_ap_policy" {
  name   = "hmpps_manage_offences_api_prod_ap_policy"
  policy = data.aws_iam_policy_document.hmpps_manage_offences_api_prod_ap_policy.json
