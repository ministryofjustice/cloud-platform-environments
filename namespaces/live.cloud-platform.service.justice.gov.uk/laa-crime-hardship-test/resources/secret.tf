module "secrets_manager" {
  ...
  secrets = {
    "maat_api_oauth_client_id" = {
      description             = "MAAT API oauth client ID for Hardship test",
      recovery_window_in_days = 7
      k8s_secret_name         = "maat-api-oauth-client-id"
    },
    "maat_api_oauth_client_secret" = {
      description             = "MAAT API oauth client secret for Hardship test",
      recovery_window_in_days = 7
      k8s_secret_name         = "maat-api-oauth-client-secret"
    },
    "ccc_api_oauth_client_id" = {
      description             = "CCC API oauth client ID for Hardship test",
      recovery_window_in_days = 7
      k8s_secret_name         = "ccc-api-oauth-client-id"
    },
    "ccc_api_oauth_client_secret" = {
      description             = "CCC API oauth client secret for Hardship test",
      recovery_window_in_days = 7
      k8s_secret_name         = "ccc-api-oauth-client-secret"
    },
    "cma_api_oauth_client_id" = {
      description             = "CMA API oauth client ID for Hardship Test",
      recovery_window_in_days = 7,
      k8s_secret_name         = "cma-api-oauth-client-id"
    },
    "cma_api_oauth_client_secret" = {
      description             = "CMA API oauth client secret for Hardship Test",
      recovery_window_in_days = 7,
      k8s_secret_name         = "cma-api-oauth-client-secret"
    },
    "sentry_dsn" = {
      description             = "Sentry Data Source Name (DSN) for Hardship Test",
      recovery_window_in_days = 7,
      k8s_secret_name         = "sentry-dsn"
    },
    "ingress_internal_allowlist_source_range" = {
      description             = "Internal IP allowlist for Hardship Test",
      recovery_window_in_days = 7,
