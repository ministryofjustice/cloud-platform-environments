module "approved_premises_manage_a_resident_ui" {
  source      = "github.com/ministryofjustice/cloud-platform-terraform-hmpps-template?ref=1.1.0"
  github_repo = "hmpps-approved-premises-manage-a-resident-ui"
  application = "hmpps-approved-premises-manage-a-resident-ui"
