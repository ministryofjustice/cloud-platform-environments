module "secrets_manager_multiple_secrets" {
  ...
  secrets = {  
    "laa-landing-page-secret-azure-client-id-prd" = {
    ...
    "laa-landing-page-secret-azure-client-secret-prd" = {
    ...
    "laa-landing-page-secret-azure-tenant-secret-prd" = {
    ...
    "laa-landing-page-base-api-url-prd" = {
      description             = "prd landing page base api url",
      recovery_window_in_days = 7
    ...
    "laa-landing-page-secret-notify-key-prd" = {
      description             = "prd notify key",
      recovery_window_in_days = 7
