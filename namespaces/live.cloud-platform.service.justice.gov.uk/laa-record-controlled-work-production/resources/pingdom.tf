...
resource "pingdom_check" "laa-record-controlled-work-rcw-production" {
  type             = "http"
  name             = "Record controlled work (RCW) - PRODUCTION"
  host             = "laa-record-controlled-work-production.cloud-platform.service.justice.gov.uk"
  resolution       = 1
