...
module "contacts_elasticache_redis" {
  ...
  application            = module.hmpps-probation-supervision-contacts-ui.application
  is_production          = var.is_production
  namespace              = var.namespace
...
resource "kubernetes_secret" "elasticache_redis_contacts-ui" {
  metadata {
    name      = "${module.hmpps-probation-supervision-contacts-ui.application}-elasticache-redis"
    namespace = var.namespace
  }
