...
resource "pingdom_check" "laa-review-criminal-legal-aid-healthcheck" {
  ...
  encryption               = true
  port                     = 443
  tags                     = "businessunit_${var.business_unit},application_laa-review-criminal-legal-aid,component_ping,isproduction_${var.is_production},environment_production,infrastructuresupport_crime-apply-team"
