...
variable "namespace" {
  ...
  type        = string
  default     = "hmpps-community-accommodation-tier-2-prototype"
}
...
variable "team_name" {
  ...
  type        = string
  default     = "hmpps-community-accommodation-tier-2"
}
