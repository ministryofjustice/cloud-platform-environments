...
locals {
  sqs_queues = {
    "Digital-Prison-Services-dev-hmpps_domain_event_logger_dlq"   = "hmpps-domain-events-dev"
    "Digital-Prison-Services-dev-hmpps_domain_event_logger_queue" = "hmpps-domain-events-dev"
  }
