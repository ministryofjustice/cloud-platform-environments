...
locals {
  sqs_queues = {
    ...
    "Digital-Prison-Services-preprod-keyworker_api_queue_complexity_of_need"    = "hmpps-domain-events-preprod",
    "Digital-Prison-Services-preprod-keyworker_api_queue_dl_complexity_of_need" = "hmpps-domain-events-preprod"
  }
