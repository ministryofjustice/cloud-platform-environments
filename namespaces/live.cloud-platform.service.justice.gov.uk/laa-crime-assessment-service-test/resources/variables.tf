variable "vpc_name" {
  description = "VPC name to create security groups for the ElastiCache and RDS modules"
  type        = string
}
...
variable "namespace" {
  ...
  type        = string
  default     = "laa-crime-assessment-service-test"
}
...
variable "infrastructure_support" {
  ...
  type        = string
  default     = "laa-crime-assess-apps-modernisation@justice.gov.uk"
}
