...
resource "pingdom_check" "money-to-prisoners-prod-send-money" {
  ...
  tags = "businessunit_${lower(var.business_unit)},application_${var.application},component_send-money,isproduction_${var.is_production},environment_${var.environment},cloudplatform-managed"
...
resource "pingdom_check" "money-to-prisoners-prod-start-page" {
  ...
  tags = "businessunit_${lower(var.business_unit)},application_${var.application},component_start-page,isproduction_${var.is_production},environment_${var.environment},cloudplatform-managed"
...
resource "pingdom_check" "money-to-prisoners-prod-emails" {
  ...
  tags = "businessunit_${lower(var.business_unit)},application_${var.application},component_emails,isproduction_${var.is_production},environment_${var.environment},cloudplatform-managed"
