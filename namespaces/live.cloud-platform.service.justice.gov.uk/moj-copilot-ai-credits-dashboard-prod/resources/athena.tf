...
resource "aws_glue_crawler" "copilot_credits_prod_crawler" {
  #checkov:skip=CKV_AWS_195: "Ensure Glue component has a security configuration associated"

  name          = "copilot_credits_prod_crawler"
...
resource "aws_athena_workgroup" "copilot_credits_prod_workgroup" {
  name = "copilot_credits_prod_workgroup"
