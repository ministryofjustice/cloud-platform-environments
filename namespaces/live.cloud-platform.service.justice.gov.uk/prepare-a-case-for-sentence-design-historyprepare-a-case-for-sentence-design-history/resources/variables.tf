...
variable "namespace" {
  ...
  type        = string
  default     = "prepare-a-case-for-sentence-design-historyprepare-a-case-for-sentence-design-history"
}
