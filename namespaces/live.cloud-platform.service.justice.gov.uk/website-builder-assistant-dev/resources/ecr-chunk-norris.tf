 ...
 *
 */
module "ecr_chunk_norris" {
  source = "github.com/ministryofjustice/cloud-platform-terraform-ecr-credentials?ref=8.0.0"

  repo_name = "${var.namespace}-chunk-norris-ecr"
  ...
  github_repositories = ["chunk-norris"]
...
resource "kubernetes_secret" "ecr_chunk_norris" {
  metadata {
    name      = "ecr-repo-chunk-norris-${var.namespace}"
    namespace = var.namespace
  }

  data = {
    repo_arn = module.ecr_chunk_norris.repo_arn
    repo_url = module.ecr_chunk_norris.repo_url
  }
}
