module "secrets_manager" {
  ...
  secrets = {
    "feature_flags" = {
      description             = "[laa-dces-report-service-dev/feature-flags] Feature flag variables"
      recovery_window_in_days = 7
      k8s_secret_name         = "feature-flags"
    }
    "config-variables" = {
      description             = "[laa-dces-report-service-dev/config-variables] Configuration variables and settings"
      recovery_window_in_days = 7
