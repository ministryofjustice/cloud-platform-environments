data "aws_iam_policy_document" "sqs_full" {
  ...
  statement {
    ...
    resources = [
      ...
      module.ims_sanitisation_request_queue.sqs_arn,
      module.ims_sanitisation_request_dlq.sqs_arn,
      module.ims_sanitisation_response_queue.sqs_arn,
      module.ims_sanitisation_response_dlq.sqs_arn,
    ]
  }
}
...
module "irsa" {
  ...
  role_policy_arns = merge(local.sns_policies, {
    ...
    s3_sanitisation  = module.ims_sanitisation_bucket.irsa_policy_arn
  })
