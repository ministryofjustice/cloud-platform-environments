...
resource "kubernetes_secret" "manage_intelligence_rds_aurora" {
  ...
  data = {
    ...
    manage_intelligence_update_password = random_id.manage_intelligence_update_role_password.b64_std
    manage_intelligence_read_password   = random_id.manage_intelligence_read_role_password.b64_std
