...
module "irsa" {
  ...
  role_policy_arns     = merge(local.sqs_policies, local.sns_policies, {combined_local_sqs = aws_iam_policy.combined_local_sqs.arn}, {rds_policy = module.rds.irsa_policy_arn})
