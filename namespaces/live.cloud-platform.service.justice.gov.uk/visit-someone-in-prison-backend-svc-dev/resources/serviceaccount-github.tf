locals {
  ...
  github_repos   = ["hmpps-visit-allocation-api", "prisoner-contact-registry", "hmpps-notifications-alerts-vsip", "hmpps-prison-visit-booker-registry", "hmpps-prison-visits-testing-helper-api", "hmpps-manage-prison-visits-orchestration", "visit-scheduler"]
