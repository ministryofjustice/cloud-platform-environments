...
locals {
  sqs_irsa_policies = {
    ...
    (module.hmpps_registers_to_delius_queue.sqs_name)                               = module.hmpps_registers_to_delius_queue.irsa_policy_arn,
    (module.hmpps_registers_to_delius_dead_letter_queue.sqs_name)                   = module.hmpps_registers_to_delius_dead_letter_queue.irsa_policy_arn,
    (module.hmpps_registers_to_nomis_queue.sqs_name)                                = module.hmpps_registers_to_nomis_queue.irsa_policy_arn,
    (module.hmpps_registers_to_nomis_dead_letter_queue.sqs_name)                    = module.hmpps_registers_to_nomis_dead_letter_queue.irsa_policy_arn,
