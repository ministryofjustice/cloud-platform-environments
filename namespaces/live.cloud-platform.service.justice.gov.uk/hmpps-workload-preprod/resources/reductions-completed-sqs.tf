...
resource "kubernetes_secret" "hmpps_reductions_completed_event_queue" {
  metadata {
    name      = "hmpps-reductions-completed-sqs-output"
    namespace = var.namespace
  }
  ...
  data = {
    ...
    sqs_url           = module.hmpps_reductions_completed_queue.sqs_id
    sqs_arn           = module.hmpps_reductions_completed_queue.sqs_arn
    sqs_name          = module.hmpps_reductions_completed_queue.sqs_name
  }
}

resource "kubernetes_secret" "hmpps_reductions_completed_dead_letter_queue" {
  metadata {
    name      = "hmpps-reductions-completed-sqs-dl-output"
    namespace = var.namespace
  }
  ...
  data = {
    ...
    sqs_url           = module.hmpps_reductions_completed_dead_letter_queue.sqs_id
    sqs_arn           = module.hmpps_reductions_completed_dead_letter_queue.sqs_arn
    sqs_name          = module.hmpps_reductions_completed_dead_letter_queue.sqs_name
  }
}
