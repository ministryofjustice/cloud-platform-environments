module "secrets_manager" {
  ...
  secrets = {
    "laa-amend-a-claim-azure-client-id-staging" = {
    ...
    "laa-amend-a-claim-azure-client-secret-staging" = {
    ...
    "laa-amend-a-claim-azure-tenant-secret-staging" = {
    ...
    "laa-amend-a-claim-base-url-staging" = {
      description             = "Staging landing page base url",
      recovery_window_in_days = 7
    ...
    "laa-amend-a-claim-sentry-dsn-staging" = {
    ...
    "laa-amend-a-claim-provider-api-url" = {
      description             = "Staging Provider Api Url",
      recovery_window_in_days = 7
