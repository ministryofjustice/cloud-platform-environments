...
resource "kubernetes_secret" "rds" {
  ...
  data = {
    ...
    url                   = "postgres://${module.rds.database_username}:${module.module_name.database_password}@${module.module_name.rds_instance_endpoint}/${module.module_name.database_name}"
  }
