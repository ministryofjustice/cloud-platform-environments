...
resource "aws_route53_record" "ccrc_route53_txt_record_main" {
  ...
  type    = "TXT"
  ttl     = "300"
  records = ["MS=ms13510705", "moTzn29k+pERDZNgHyOtkGiR+/ckQKBhpJDwsM558yZCe4wETnTgQswUIVDMjxIQrRQyPxznbg0qy6o17si9qQ==", "v=spf1 include:spf.protection.outlook.com ip4:80.6.91.150 -all", "68mnpg8h53n9jr4htpl2529xm5jyvx4f", "v=spf1 include:mailgun.org ip4:141.193.33.66 ~all"]
}
