variable "domains" {
  ...
  default = {
    ...
    "complaints.judicialconduct.gov.uk"               = "jcio"
    ...
    "deathsindetention.independent-panel.uk"          = "iapdd"
    ...
    "jcio.uk"                                         = "jcio-uk"
    "judicialappointments.gov.uk"                     = "judicialappointments"
    ...
    "www.complaints.judicialconduct.gov.uk"           = "jcio-www"
    "www.deathsindetention.independent-panel.uk"      = "iapdd-www"
