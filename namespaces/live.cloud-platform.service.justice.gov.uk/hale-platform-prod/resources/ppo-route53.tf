...
resource "aws_route53_record" "ppo_route53_txt_record_servers" {
  ...
  type    = "TXT"
  ttl     = "300"
  records = ["MS=ms15192188", "atlassian-domain-verification=eZYa71sfUYC3GKWDAnR6IDBAD7m0PkEaKKOYkM2cjWj8or0XT0PwqvFpqTLtaNby", "v=spf1 ip4:194.33.196.8/32 ip4:194.33.192.8/32 include:spf.protection.outlook.com include:servers.mcsv.net -all", "miro-verification=9f7733fab8b41c5d9bbbf63c043f10dcfec77dab", "openai-domain-verification=dv-ivL0ekG2HGKIuSNcCY5eAQ7i"]
}
