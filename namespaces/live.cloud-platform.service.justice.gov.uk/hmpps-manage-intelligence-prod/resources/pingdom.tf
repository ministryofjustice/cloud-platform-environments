...
resource "pingdom_check" "transformer" {
  ...
  notifyagainevery         = 0
  url                      = "/https/mercury-data-transform-load.hmpps.service.justice.gov.uk"
  encryption               = true
  port                     = 443
...
resource "pingdom_check" "manage-intelligence" {
  ...
  sendnotificationwhendown = 6
  notifyagainevery         = 0
  url                      = "/https/manage-intelligence.prison.service.justice.gov.uk"
  encryption               = true
  port                     = 443
  tags                     = "dps,hmpps,cloudplatform-managed"
  probefilters             = "region:EU"
...
resource "pingdom_check" "manage-intelligence-api" {
  ...
  sendnotificationwhendown = 6
  notifyagainevery         = 0
  url                      = "/https/manage-intelligence-api.prison.service.justice.gov.uk/"
  encryption               = true
  port                     = 443
  tags                     = "dps,hmpps,cloudplatform-managed"
  probefilters             = "region:EU"
