...
resource "pingdom_check" "hmpps-micro-frontend-components-preprod-check" {
  ...
  encryption               = true
  port                     = 443
  tags                     = "businessunit_HMPPS,application_hmpps-micro-frontend-components,component_healthcheck,isproduction_false,environment_preprod,cloudplatform-managed"
