...
variable "application" {
  ...
  type        = string
  default     = "LAA Data Stewardship Payments Service"
}

variable "namespace" {
  description = "Name of the namespace these resources are part of"
  type        = string
  default     = "laa-data-stewardship-payments-staging"
}
...
variable "serviceaccount_name" {
  ...
  default     = "laa-data-stewardship-payments-staging-service-account"
}
