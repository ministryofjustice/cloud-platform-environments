locals {
  github_repos = ["hmpps-manage-custody-mailbox-register", "hmpps-manage-custody-mailbox-register-api"]
...
data "github_team" "mailbox-register-devs" {
  slug = "mailbox-register-devs"
}
