...
module "s3_bucket" {
  ...
  bucket_name            = "hmpps-cfo-case-assessment-tracking-system-bucket-${var.environment}"
...
module "sqlserver_backup_s3_bucket" {
  ...
  bucket_name            = "hmpps-cfo-case-assessment-tracking-system-backup-${var.environment}"
  team_name              = var.team_name
  business_unit          = var.business_unit
  application            = var.application
  is_production          = var.is_production
