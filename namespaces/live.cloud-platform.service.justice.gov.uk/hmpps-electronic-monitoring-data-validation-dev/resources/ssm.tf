...
data "aws_ssm_parameter" "data_store_update_p1_role_arn" {
...
resource "aws_ssm_parameter" "data_store_test_tags_arn" {
  name        = "/${var.namespace}/data_store_test_tags_arn"
  type        = "SecureString"
  # This value must be replaced with a genuine role ARN using AWS CLI
  value       = "arn:aws:iam::0000000000000:role/general-placeholder"
  description = "ARN of the role used to get data on test tags."
  tags        = local.tags
  lifecycle {
    ignore_changes = [
      value
