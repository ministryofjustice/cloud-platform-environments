...
variable "application" {
  ...
  default     = "HMPPS Electronic Monitoring Data Validation"
}
...
variable "infrastructure_support" {
  ...
  default     = "EMDataEngineering@justice.gov.uk"
}
...
variable "domain" {
  default = "data-validation-dev.electronic-monitoring.service.justice.gov.uk"
}
