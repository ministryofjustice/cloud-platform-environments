...
resource "aws_cognito_user_pool_client" "maat_uat" {
...
resource "kubernetes_secret" "aws_cognito_user_pool_client" {
  ...
  data = {
    maat_client_id     = aws_cognito_user_pool_client.maat_uat.id
    maat_client_secret = aws_cognito_user_pool_client.maat_uat.client_secret
  }
}