...
resource "aws_sns_topic_subscription" "cvl_prison_events_subscription" {
  ...
  filter_policy = "{\"eventType\":[\"ADDRESS-UPDATED\", \"BOOKING_NUMBER-CHANGED\", \"CONFIRMED_RELEASE_DATE-CHANGED\", \"DATA_COMPLIANCE_DELETE-OFFENDER\", \"OFFENDER-UPDATED\", \"OFFENDER_BOOKING-CHANGED\", \"OFFENDER_DETAILS-CHANGED\", \"OFFENDER_PROFILE_DETAILS-UPDATED\", \"SENTENCE_DATES-CHANGED\", \"SENTENCE_CALCULATION_DATES-CHANGED\"]}"
}
