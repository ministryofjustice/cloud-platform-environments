...
resource "aws_sns_topic_subscription" "prisoner_offender_events_subscription" {
  ...
  filter_policy = jsonencode({
    eventType = [
      ...
      "OFFENDER_SENTENCES-INSERTED", "OFFENDER_SENTENCES-UPDATED", "OFFENDER_SENTENCES-DELETED",
      "OFFENDER_SENTENCE_TERMS-INSERTED", "OFFENDER_SENTENCE_TERMS-UPDATED", "OFFENDER_SENTENCE_TERMS-DELETED",
      "APPOINTMENT_CHANGED",
      "OFFENDER_FINE_PAYMENTS-INSERTED", "OFFENDER_FINE_PAYMENTS-UPDATED", "OFFENDER_FINE_PAYMENTS-DELETED",
      "OFFENDER_FIXED_TERM_RECALLS-INSERTED", "OFFENDER_FIXED_TERM_RECALLS-UPDATED", "OFFENDER_FIXED_TERM_RECALLS-DELETED",
    ]
  })
}
