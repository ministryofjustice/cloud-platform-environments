...
resource "aws_route53_zone" "apex_certbailiff_route53_zone" {
  name = "apex-certificatedbailiffs.justice.gov.uk"
...
resource "kubernetes_secret" "certbailiff_route53_zone_sec" {
  ...
  data = {
    zone_id = aws_route53_zone.apex_certbailiff_route53_zone.zone_id
  }
}
