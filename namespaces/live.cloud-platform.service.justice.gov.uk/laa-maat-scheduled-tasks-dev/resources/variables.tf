...
variable "application" {
  ...
  type        = string
  default     = "maat-scheduled-tasks"
}

variable "namespace" {
  description = "Name of the namespace these resources are part of"
  type        = string
  default     = "laa-maat-scheduled-tasks-dev"
}
...
variable "user_pool_name" {
  ...
  default     = "maat-scheduled-tasks-dev-userpool"
}
...
variable "resource_server_identifier" {
  ...
  default     = "maat-scheduled-tasks-dev"
}

variable "resource_server_name" {
  description = "Cognito resource server name"
  default     = "maat-scheduled-tasks-dev-resource-server"
}
