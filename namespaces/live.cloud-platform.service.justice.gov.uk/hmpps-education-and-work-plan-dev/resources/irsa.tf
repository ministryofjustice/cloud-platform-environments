...
locals {
  ...
  sqs_queues = {
    ...
    "education-and-work-plan-assessments-queue-1"                               = "hmpps-education-and-work-plan-dev",
    "education-and-work-plan-assessments-dlq"                                 = "hmpps-education-and-work-plan-dev"
  }
