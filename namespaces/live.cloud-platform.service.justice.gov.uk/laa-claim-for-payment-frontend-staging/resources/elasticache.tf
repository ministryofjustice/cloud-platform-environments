module "redis" {
  source = "github.com/ministryofjustice/cloud-platform-terraform-elasticache-cluster?ref=8.1.0" # use the latest release
...
resource "kubernetes_secret" "claimandassess_claim_redis" {
  metadata {
    name      = "claimandassess-claim-redis"
    namespace = var.namespace
  }
