...
resource "pingdom_check" "check-financial-eligibility-staging" {
  type                     = "http"
  name                     = "Check financial eligibility staging - ping"
  host                     = "check-financial-eligibility-staging.cloud-platform.service.justice.gov.uk"
  resolution               = 1
