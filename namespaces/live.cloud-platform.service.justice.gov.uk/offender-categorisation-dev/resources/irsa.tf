locals {
  sqs_queues_oc = {
    "Digital-Prison-Services-dev-offender_categorisation_ui_events_queue_dl" = "offender-events-dev"
    "Digital-Prison-Services-dev-offender_categorisation_ui_events_queue"    = "offender-events-dev"
  }
  sqs_queues_rp = {
