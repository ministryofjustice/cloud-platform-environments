...
resource "aws_cognito_user_pool_client" "maat_staging" {
...
resource "kubernetes_secret" "aws_cognito_user_pool_client" {
  ...
  data = {
    maat_client_id     = aws_cognito_user_pool_client.maat_staging.id
    maat_client_secret = aws_cognito_user_pool_client.maat_staging.client_secret
  }
}