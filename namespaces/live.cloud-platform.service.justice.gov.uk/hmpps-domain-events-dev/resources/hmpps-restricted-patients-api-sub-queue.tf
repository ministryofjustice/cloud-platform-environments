...
resource "kubernetes_secret" "restricted_patients_queue_for_domain_events" {
  ...
  data = {
    ...
    sqs_wb_url        = module.restricted_patients_queue_for_domain_events.sqs_id
    sqs_wb_arn        = module.restricted_patients_queue_for_domain_events.sqs_arn
    sqs_wb_name       = module.restricted_patients_queue_for_domain_events.sqs_name
  }
}
...
resource "kubernetes_secret" "restricted_patients_queue_for_domain_events_dead_letter_queue" {
  ...
  data = {
    ...
    sqs_wb_url        = module.restricted_patients_queue_for_domain_events_dead_letter_queue.sqs_id
    sqs_wb_arn        = module.restricted_patients_queue_for_domain_events_dead_letter_queue.sqs_arn
    sqs_wb_name       = module.restricted_patients_queue_for_domain_events_dead_letter_queue.sqs_name
  }
}
