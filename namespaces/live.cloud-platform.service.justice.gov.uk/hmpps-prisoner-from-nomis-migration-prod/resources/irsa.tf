...
locals {
  sqs_queues = {
    ...
    "Digital-Prison-Services-prod-prisoner_from_nomis_non_associations_dl_queue" = "offender-events-prod"
    "Digital-Prison-Services-prod-prisoner_from_nomis_non_associations_queue" = "offender-events-prod"
