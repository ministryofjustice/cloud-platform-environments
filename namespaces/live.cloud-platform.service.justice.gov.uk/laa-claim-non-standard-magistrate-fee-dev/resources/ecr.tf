...
module "ecr_credentials" {
  source    = "github.com/ministryofjustice/cloud-platform-terraform-ecr-credentials?ref=bug-github-repo-not-updating-policy"
  ...
  github_repositories = ["laa-claim-non-standard-magistrate-fee-backend", "nsm-e2e-test", "laa-crime-application-store", "laa-assess-non-standard-magistrate-fee"]
