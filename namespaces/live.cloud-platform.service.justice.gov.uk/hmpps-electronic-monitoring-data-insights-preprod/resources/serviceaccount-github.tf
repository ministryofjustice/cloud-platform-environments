...
### Change these to the repositories managed by this namespace ###
  ...
  github_repos   = ["hmpps-electronic-monitoring-data-insights-ui"]
...
data "github_team" "hmpps-em-probation-live" {
slug = "hmpps-em-probation-live"
}   
...
# prevent_self_review = true
  reviewers {
    teams = [ 
      ...
      tonumber(data.github_team.hmpps-em-probation-live.id)
    ]
  }
