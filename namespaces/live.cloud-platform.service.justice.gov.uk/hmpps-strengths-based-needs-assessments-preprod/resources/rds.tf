...
resource "kubernetes_secret" "hmpps_strengths_based_needs_assessments_preprod_rds_secret" {
  ...
  data = {
    ...
    access_key_id         = module.hmpps_strengths_based_needs_assessments_preprod_rds.access_key_id
    secret_access_key     = module.hmpps_strengths_based_needs_assessments_preprod_rds.secret_access_key
