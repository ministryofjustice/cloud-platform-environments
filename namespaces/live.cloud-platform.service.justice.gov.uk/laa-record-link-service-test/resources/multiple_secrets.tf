module "secrets_manager_multiple_secrets" {
  ...
  secrets = {  
    "laa-record-link-service-azure-client-id-test" = {
    ...
    "laa-record-link-service-azure-client-secret-test" = {
    ...
    "laa-record-link-service-azure-tenant-secret-test" = {
    ...
    "laa-record-link-service-base-url-test" = {
    ...
    "rds-postgresql-instance-output-test" = {
