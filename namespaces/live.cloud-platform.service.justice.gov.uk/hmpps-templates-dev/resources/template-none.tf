# For Cloud Platform deployed projects not based on the Typescript or Kotlin template:
...
module "hmpps_template_none" {
  source      = "github.com/ministryofjustice/cloud-platform-terraform-hmpps-template?ref=1.1.0"
  github_repo = "hmpps-your-project"
  application = "hmpps-your-project"
  github_team = "hmpps-team"
