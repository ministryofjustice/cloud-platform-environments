locals {
  ...
  sqs_queues = {
    "Digital-Prison-Services-dev-education_and_work_plan_domain_events_queue" = "hmpps-domain-events-preprod",
    "Digital-Prison-Services-dev-education_and_work_plan_domain_events_dl" = "hmpps-domain-events-preprod"
  }
