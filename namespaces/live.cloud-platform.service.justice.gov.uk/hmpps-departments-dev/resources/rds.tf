...
module "read_replica" {
  ...
  replicate_source_db = module.hmpps_departments_rds.db_identifier
...
resource "kubernetes_secret" "hmpps_departments_rds" {
  metadata {
  ...
  data = {
    rds_instance_endpoint = module.hmpps_departments_rds.rds_instance_endpoint
    database_name         = module.hmpps_departments_rds.database_name
    database_username     = module.hmpps_departments_rds.database_username
    database_password     = module.hmpps_departments_rds.database_password
    rds_instance_address  = module.hmpps_departments_rds.rds_instance_address
  }
