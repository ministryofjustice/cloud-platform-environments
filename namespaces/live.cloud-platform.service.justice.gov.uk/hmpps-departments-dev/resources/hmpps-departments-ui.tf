module "hmpps_departments_ui" {
  source      = "github.com/ministryofjustice/cloud-platform-terraform-hmpps-template?ref=1.2.1"
  force_rotate_token = true
  custom_token_rotation_date = "2026-03-20"
  github_repo = "hmpps-departments-ui"
  application = "hmpps-departments-ui"
  github_team = "hmpps-launchpad-devs"
...
module "elasticache_redis" {
  ...
  application            = module.hmpps_departments_ui.application
  is_production          = var.is_production
  namespace              = var.namespace
...
resource "kubernetes_secret" "elasticache_redis" {
  metadata {
    name      = "${module.hmpps_departments_ui.application}-elasticache-redis"
    namespace = var.namespace
  }
