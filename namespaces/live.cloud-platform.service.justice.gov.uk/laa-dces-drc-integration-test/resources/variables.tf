...
variable "namespace" {
  ...
  type        = string
  default     = "laa-dces-drc-integration-test"
}
...
variable "resource_server_name" {
  ...
  default     = "dces-drc-api-test-resource-server"
}
...
variable "db_name" {
  ...
  type        = string
  default     = "laa_dces_drc_integration_test_db"
}
