...
module "read_replica" {
  ...
  replicate_source_db = module.steve-rds.db_identifier
...
resource "kubernetes_secret" "steve-rds" {
  metadata {
    name      = "steve-rds-postgresql-instance-output"
    namespace = var.namespace
  }

  data = {
    rds_instance_endpoint = module.steve-rds.rds_instance_endpoint
    database_name         = module.steve-rds.database_name
    database_username     = module.steve-rds.database_username
    database_password     = module.steve-rds.database_password
    rds_instance_address  = module.steve-rds.rds_instance_address
  }
  /* You can replace all of the above with the following, if you prefer to
     * use a single database URL value in your application code:
     *
     * url = "postgres://${module.steve-rds.database_username}:${module.steve-rds.database_password}@${module.steve-rds.rds_instance_endpoint}/${module.steve-rds.database_name}"
     *
     */
}
...
resource "kubernetes_config_map" "steve-rds" {
  metadata {
    name      = "steve-rds-postgresql-instance-output"
    namespace = var.namespace
  }
  ...
  data = {
    database_name = module.steve-rds.database_name
    db_identifier = module.steve-rds.db_identifier
