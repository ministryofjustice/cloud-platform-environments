locals {
  sqs_queues_oc = {
    "Digital-Prison-Services-preprod-offender_categorisation_ui_events_queue_dl" = "offender-events-preprod"
    "Digital-Prison-Services-preprod-offender_categorisation_ui_events_queue"    = "offender-events-preprod"
  }
  sqs_queues_rp = {
