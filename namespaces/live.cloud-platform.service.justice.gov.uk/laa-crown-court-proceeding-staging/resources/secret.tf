module "secrets_manager" {
  ...
  secrets = {
    "maat_api_oauth_client_id" = {
      description             = "MAAT API oauth client ID for CCP Staging",
      recovery_window_in_days = 7
      k8s_secret_name         = "maat-api-oauth-client-id"
    },
    "maat_api_oauth_client_secret" = {
      description             = "MAAT API oauth client secret for CCP Staging",
      recovery_window_in_days = 7
      k8s_secret_name         = "maat-api-oauth-client-secret"
    },
    "cda_oauth_client_id" = {
      description             = "Court Data API oauth client ID for CCP Staging",
      recovery_window_in_days = 7
      k8s_secret_name         = "cda-oauth-client-id"
    },
    "cda_oauth_client_secret" = {
      description             = "Court Data API oauth client secret for CCP Staging",
      recovery_window_in_days = 7
      k8s_secret_name         = "cda-oauth-client-secret"
    },
    "evidence_oauth_client_id" = {
      description             = "Evidence Service oauth client ID for CCP Staging",
      recovery_window_in_days = 7
      k8s_secret_name         = "evidence-oauth-client-id"
    },
    "evidence_oauth_client_secret" = {
      description             = "Evidence Service oauth client secret for CCP Staging",
      recovery_window_in_days = 7
