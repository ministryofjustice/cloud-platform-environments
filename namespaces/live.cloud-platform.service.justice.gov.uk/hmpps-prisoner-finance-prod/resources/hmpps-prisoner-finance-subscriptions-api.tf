module "hmpps_prisoner_finance_subscriptions_prod" {
  source                     = "github.com/ministryofjustice/cloud-platform-terraform-hmpps-template?ref=1.2.2"
  force_rotate_token         = true
  custom_token_rotation_date = "2026-03-20"
  github_repo                = "hmpps-prisoner-finance-subscriptions-api"
  application                = "hmpps-prisoner-finance-subscriptions-api"
