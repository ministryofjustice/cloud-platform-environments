module "hmpps_prisoner_finance_ui" {
...
module "elasticache_redis" {
  ...
  application            = module.hmpps_prisoner_finance_ui.application
  is_production          = var.is_production
  namespace              = var.namespace
...
resource "kubernetes_secret" "elasticache_redis" {
  metadata {
    name      = "${module.hmpps_prisoner_finance_ui.application}-elasticache-redis"
    namespace = var.namespace
  }
