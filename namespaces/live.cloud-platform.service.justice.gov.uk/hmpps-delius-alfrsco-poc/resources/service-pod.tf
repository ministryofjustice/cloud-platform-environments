module "irsa" {
  source = "github.com/ministryofjustice/cloud-platform-terraform-irsa?ref=v2.0.0"
...
module "service_pod" {
  source = "github.com/ministryofjustice/cloud-platform-terraform-service-pod?ref=v1.0.0"
