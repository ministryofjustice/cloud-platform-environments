locals {
  sqs_queues = {
    "Digital-Prison-Services-prod-pic_probation_offender_events_queue"    = "offender-events-prod"
    "Digital-Prison-Services-prod-pic_probation_offender_events_queue_dl" = "offender-events-prod"
  }
  sns_topics = {
