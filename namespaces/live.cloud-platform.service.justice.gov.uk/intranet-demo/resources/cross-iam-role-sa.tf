module "cross_irsa" {
  ...
  role_policy_arns       = { s3 = aws_iam_policy.intranet_demo_s3_staging.arn }
}

data "aws_iam_policy_document" "intranet_demo_s3_staging" {
...
resource "aws_iam_policy" "intranet_demo_s3_staging" {
  name   = "intranet_demo_s3_staging"
  policy = data.aws_iam_policy_document.intranet_demo_s3_staging.json
