...
locals {
  ...
  sqs_queues = {
    ...
    "hmpps-farsight-reduce-re-offend-dev-eawp_assessment_events_queue"        = "hmpps-education-and-work-plan-dev",
    "hmpps-farsight-reduce-re-offend-prod-eawp_domain_events_dlq"             = "hmpps-education-and-work-plan-dev"
  }
