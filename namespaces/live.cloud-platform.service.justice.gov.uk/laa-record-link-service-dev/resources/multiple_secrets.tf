module "secrets_manager_multiple_secrets" {
  ...
  secrets = {  
    "laa-record-link-service-azure-client-id-dev" = {
    ...
    "laa-record-link-service-azure-client-secret-dev" = {
    ...
    "laa-record-link-service-azure-tenant-secret-dev" = {
    ...
    "laa-record-link-service-base-url-dev" = {
    ...
    "rds-postgresql-instance-output-dev" = {
