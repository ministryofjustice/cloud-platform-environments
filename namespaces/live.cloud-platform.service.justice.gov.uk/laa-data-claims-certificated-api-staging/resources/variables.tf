...
variable "application" {
  ...
  type        = string
  default     = "Data Claims Certificated API"
}

variable "namespace" {
  description = "Name of the namespace these resources are part of"
  type        = string
  default     = "laa-data-claims-certificated-api-staging"
}
...
variable "serviceaccount_name" {
  ...
  default     = "laa-data-claims-certificated-api-staging-service-account"
}

variable "repo_name" {
  default = "laa-data-claims-certificated-api"
}