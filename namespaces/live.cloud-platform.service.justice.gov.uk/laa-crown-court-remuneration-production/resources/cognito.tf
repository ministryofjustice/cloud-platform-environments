...
resource "aws_cognito_user_pool_client" "maat_production" {
...
resource "kubernetes_secret" "aws_cognito_user_pool_client" {
  metadata {
    name      = "ccr-cognito-client-secret-output"
    namespace = var.namespace
  }

  data = {
    maat_client_id     = aws_cognito_user_pool_client.maat_production.id
    maat_client_secret = aws_cognito_user_pool_client.maat_production.client_secret
  }
}
