...
variable "team_name" {
  description = "The name of your preproduction team"
...
variable "domain" {
  default = "person-match-preprod.electronic-monitoring.service.justice.gov.uk"
}
