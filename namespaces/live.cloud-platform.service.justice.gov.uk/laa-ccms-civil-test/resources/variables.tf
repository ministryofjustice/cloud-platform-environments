...
variable "github_actions_secret_ecr_access_key" {
  ...
  default     = "ECR_AWS_ACCESS_KEY_ID_TEST"
}
...
variable "github_actions_secret_ecr_secret_key" {
  ...
  default     = "ECR_AWS_SECRET_ACCESS_KEY_TEST"
}
