resource "helm_release" "cloud_platform_canary" {
  ...
  values = [templatefile("${path.module}/values.yaml", {
    external_dns  = "cloud-platform-canary-app-podinfo-cloud-platform-canary-app-eks-blue"
...
resource "helm_release" "cloud_platform_modsec_canary" {
  ...
  values = [templatefile("${path.module}/values.yaml", {
    external_dns  = "cloud-platform-canary-app-modsec-podinfo-cloud-platform-canary-app-eks-blue"
