data "aws_iam_policy_document" "reporting_access" {
  ...
  statement {
    ...
    resources = [
      "arn:aws:s3:::eu-west-2-delius-prod-dfi-extracts/dfinterventions/dfi/*",
      "arn:aws:s3:::eu-west-2-delius-prod-dfi-extracts/dfinterventions/dfi/",
      "arn:aws:s3:::eu-west-2-delius-prod-dfi-extracts/exports/csv/reports/*",
      "arn:aws:s3:::eu-west-2-delius-prod-dfi-extracts/exports/csv/reports/"
    ]
  }
}
...
resource "kubernetes_secret" "reporting_aws_secret" {
  ...
  data = {
    destination_bucket = "s3://eu-west-2-delius-prod-dfi-extracts/dfinterventions/dfi"
