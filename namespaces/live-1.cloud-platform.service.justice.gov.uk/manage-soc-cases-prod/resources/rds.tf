...
data "aws_iam_policy_document" "manage_soc_cases_prod_rds_to_s3_export_policy" {
...
resource "aws_iam_user_policy" "policy" {
  ...
  policy = data.aws_iam_policy_document.manage_soc_cases_prod_rds_to_s3_export_policy.json
  user   = aws_iam_user.user.name
}
