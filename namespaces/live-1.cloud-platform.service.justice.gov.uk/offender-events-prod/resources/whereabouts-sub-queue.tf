...
resource "kubernetes_secret" "whereabouts_api_queue" {
  ...
  data = {
    ...
    sqs_ocne_url      = module.whereabouts_api_queue.sqs_id
    sqs_ocne_arn      = module.whereabouts_api_queue.sqs_arn
    sqs_ocne_name     = module.whereabouts_api_queue.sqs_name
  }
}
...
resource "kubernetes_secret" "whereabouts_api_dead_letter_queue" {
  ...
  data = {
    ...
    sqs_ocne_url      = module.whereabouts_api_dead_letter_queue.sqs_id
    sqs_ocne_arn      = module.whereabouts_api_dead_letter_queue.sqs_arn
    sqs_ocne_name     = module.whereabouts_api_dead_letter_queue.sqs_name
  }
}
