...
resource "aws_route53_record" "contact-moj_route53_sendgrid_1495674" {
  zone_id = aws_route53_zone.contact-moj_route53_zone.zone_id
  name    = "1495674"
  type    = "CNAME"
  ttl     = "300"
...
resource "aws_route53_record" "contact-moj_route53_sendgrid_s1" {
  zone_id = aws_route53_zone.contact-moj_route53_zone.zone_id
  name    = "s1._domainkey"
  type    = "CNAME"
  ttl     = "300"
...
resource "aws_route53_record" "contact-moj_route53_sendgrid_s2" {
  zone_id = aws_route53_zone.contact-moj_route53_zone.zone_id
  name    = "s2._domainkey"
  type    = "CNAME"
  ttl     = "300"
...
resource "aws_route53_record" "contact-moj_route53_sendgrid_email" {
  zone_id = aws_route53_zone.contact-moj_route53_zone.zone_id
  name    = "email"
  type    = "CNAME"
  ttl     = "300"
...
resource "aws_route53_record" "contact-moj_route53_sendgrid_mail" {
  zone_id = aws_route53_zone.contact-moj_route53_zone.zone_id
  name    = "mail"
  type    = "CNAME"
  ttl     = "300"
...
resource "aws_route53_record" "contact-moj_route53_sendgrid_dmarc" {
  zone_id = aws_route53_zone.contact-moj_route53_zone.zone_id
  name    = "_dmarc"
  type    = "TXT"
  ttl     = "300"
...
resource "aws_route53_record" "contact-moj_route53_mx" {
  zone_id = aws_route53_zone.contact-moj_route53_zone.zone_id
  name    = "."
  type    = "MX"
  ttl     = "300"
