...
resource "kubernetes_secret" "prisoner_offender_events_queue" {
  ...
  data = {
    ...
    sqs_pos_url       = module.prisoner_offender_events_queue.sqs_id
    sqs_pos_arn       = module.prisoner_offender_events_queue.sqs_arn
    sqs_pos_name      = module.prisoner_offender_events_queue.sqs_name
  }
}
...
resource "kubernetes_secret" "prisoner_offender_events_dead_letter_queue" {
  ...
  data = {
    ...
    sqs_pos_url       = module.prisoner_offender_events_dead_letter_queue.sqs_id
    sqs_pos_arn       = module.prisoner_offender_events_dead_letter_queue.sqs_arn
    sqs_pos_name      = module.prisoner_offender_events_dead_letter_queue.sqs_name
  }
}
...
resource "aws_sns_topic_subscription" "prisoner_offender_events_subscription" {
  ...
  filter_policy = "{\"eventType\":[ \"OFFENDER_MOVEMENT-RECEPTION\", \"OFFENDER_MOVEMENT-DISCHARGE\"] }"
}
