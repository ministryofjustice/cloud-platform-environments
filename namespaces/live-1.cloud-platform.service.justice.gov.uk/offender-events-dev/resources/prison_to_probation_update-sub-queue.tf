...
resource "aws_sns_topic_subscription" "prison_to_probation_update_subscription" {
  ...
  filter_policy = "{\"eventType\":[ \"EXTERNAL_MOVEMENT_RECORD-INSERTED\", \"COURT_SENTENCE-CHANGED\", \"OFFENDER_BOOKING-INSERTED\", \"OFFENDER_BOOKING-REASSIGNED\", \"BOOKING_NUMBER-CHANGED\"] }"
}
