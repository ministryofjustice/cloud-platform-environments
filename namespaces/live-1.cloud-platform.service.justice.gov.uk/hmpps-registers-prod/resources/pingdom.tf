...
resource "pingdom_check" "hmpps-registers-to-delius-production-check" {
  type                     = "http"
  name                     = "DPS - hmpps-registers-to-delius-update"
  host                     = "health-kick.prison.service.justice.gov.uk"
  resolution               = 1
  notifywhenbackup         = true
  sendnotificationwhendown = 6
  notifyagainevery         = 0
  url                      = "/https/${var.domain_hmpps_registers_to_delius}"
  encryption               = true
  port                     = 443
  tags                     = "dps,hmpps,cloudplatform-managed"
  probefilters             = "region:EU"
