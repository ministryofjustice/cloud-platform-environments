...
resource "kubernetes_secret" "pin_phone_monitor_rds_aurora" {
  ...
  data = {
    ...
    database_name               = "refer to pin-phone-monitor-rds-aurora-migration for migrated values"
    database_username           = "refer to pin-phone-monitor-rds-aurora-migration for migrated values"
