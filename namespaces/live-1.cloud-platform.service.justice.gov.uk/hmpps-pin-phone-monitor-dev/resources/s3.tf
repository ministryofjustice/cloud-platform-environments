...
resource "kubernetes_secret" "hmpps_pin_phone_monitor_rds_to_s3_bucket" {
  metadata {
    name      = "hmpps-pin-phone-monitor-rds-to-s3-bucket-output"
    namespace = var.namespace
  }

  data = {
    access_key_id     = module.hmpps_pin_phone_monitor_rds_to_s3_bucket.access_key_id
    secret_access_key = module.hmpps_pin_phone_monitor_rds_to_s3_bucket.secret_access_key
    bucket_arn        = module.hmpps_pin_phone_monitor_rds_to_s3_bucket.bucket_arn
    bucket_name       = module.hmpps_pin_phone_monitor_rds_to_s3_bucket.bucket_name
  }
}
