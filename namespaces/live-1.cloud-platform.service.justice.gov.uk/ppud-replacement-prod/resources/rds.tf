...
module "ppud_replacement_prod_rds" {
  ...
  rds_name          = "ppud-replacement-prod"
...
resource "kubernetes_secret" "ppud_replacement_prod_rds_secrets" {
  metadata {
  ...
  data = {
    host     = module.ppud_replacement_prod_rds.rds_instance_address
    name     = module.ppud_replacement_prod_rds.database_name
    username = module.ppud_replacement_prod_rds.database_username
    password = module.ppud_replacement_prod_rds.database_password
  }
}
